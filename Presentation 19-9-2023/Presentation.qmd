...
-    I will start out with high-t continuous data.
-    I will then systematically increase the degree of ordinalization (decrease the number of categories/*course-grain* the data), reduce the number of time points, and then see how it changes the summary statistics.
-    Exact implementation is unknown for now (partially because it's novel, and coming to grips with it takes time and effort)
