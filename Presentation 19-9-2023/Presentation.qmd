...
-    Different summary statistics:
     ...
     2.   *Determinism*: proportion of recurrent points that form a diagonal line.
          - Says something about the predictability of the dataset. Given one number, can I expect what the next one is?
     3.   And many more.
...
-    We also tend to rely on *ordinal* scaling, which means we get have fewer data points.
