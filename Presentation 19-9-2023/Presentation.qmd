...
-    This analysis is based on *recurrences*: the repetition of a point (within a certain radius) after $x_{t+y}$, where t refers to the time point of x and y ∈ ℤ.
...
assessment, make using time series for self-report scales more manageable.
-    When doing research on mood, or other measures that use self-report, we often rely on fairly *course-grained* measures.
-    We also tend to rely on *ordinal* scaling: there is only a handful of categories participants can choose from.
     -    This is inherent to the self-report measure.

## Research question
-    I will perform a simulation study 
